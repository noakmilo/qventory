...
Revision ID: 035_add_ebay_top_rated
...
revision = '035_add_ebay_top_rated'
...
def upgrade():
    ...
    existing_columns = {column["name"] for column in inspector.get_columns('marketplace_credentials')}

    if 'ebay_top_rated' not in existing_columns:
